...
def playGame(wordList):
    ...
    HAND_SIZE = 7
    cnt = 0
    userInit = raw_input("Enter n to deal a new hand, or e to end game: ")
    print
    while userInit != 'e':
        cnt += 1
        if userInit == 'n':
            ...
            #while userDecision != 'u' and userDecision != 'c':
             #   print 'Invalid command.'
              #  print
               # userDecision = raw_input('Enter u to have yourself play, c to have the computer play: ')    
            #if userDecision == 'u':
            urScore = playHand(hand, wordList, HAND_SIZE)
            print
            #if userDecision == 'c':
            print
            print
            print
            print 'Now let the computer think'
            print 'ta.. dada..da....'
            time.sleep(2)
            ...
            if compScore == urScore:
                ...
                print 'Haha.., you got fucked!!. better luck next time..'
